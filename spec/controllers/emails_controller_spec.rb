...
describe EmailsController do
  ...
  describe "responding to GET index" do
    ...
    it "should expose all emails as @emails" do
      Email.should_receive(:find).with(:all).and_return([mock_email])
      get :index
      assigns[:emails].should == [mock_email]
    end
    ...
    describe "with mime type of xml" do
      ...
      it "should render all emails as xml" do
        ...
        Email.should_receive(:find).with(:all).and_return(emails = mock("Array of Emails"))
  ...
  describe "responding to GET show" do
    ...
    it "should expose the requested email as @email" do
      Email.should_receive(:find).with("37").and_return(mock_email)
      get :show, :id => "37"
  ...
  describe "responding to PUT udpate" do
    ...
    describe "with valid params" do
      ...
      it "should expose the requested email as @email" do
        Email.stub!(:find).and_return(mock_email(:update_attributes => true))
        put :update, :id => "1"
        assigns(:email).should equal(mock_email)
      end
    ...
    describe "with invalid params" do
      ...
      it "should expose the email as @email" do
        Email.stub!(:find).and_return(mock_email(:update_attributes => false))
        put :update, :id => "1"
        assigns(:email).should equal(mock_email)
      end
  ...
  describe "responding to DELETE destroy" do
    ...
    it "should redirect to the emails list" do
      Email.stub!(:find).and_return(mock_email(:destroy => true))
      delete :destroy, :id => "1"
