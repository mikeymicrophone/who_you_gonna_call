...
describe StatesController do
  ...
  describe "responding to GET index" do
    ...
    it "should expose all states as @states" do
      State.should_receive(:find).with(:all).and_return([mock_state])
      get :index
    ...
    describe "with mime type of xml" do
      ...
      it "should render all states as xml" do
        ...
        State.should_receive(:find).with(:all).and_return(states = mock("Array of States"))
        states.should_receive(:to_xml).and_return("generated XML")
        get :index
  ...
  describe "responding to GET show" do
    ...
    it "should expose the requested state as @state" do
      State.should_receive(:find).with("37").and_return(mock_state)
      get :show, :id => "37"
    ...
    describe "with mime type of xml" do
      ...
      it "should render the requested state as xml" do
        request.env["HTTP_ACCEPT"] = "application/xml"
        State.should_receive(:find).with("37").and_return(mock_state)
        mock_state.should_receive(:to_xml).and_return("generated XML")
        get :show, :id => "37"
        response.body.should == "generated XML"
      end
  ...
  describe "responding to GET new" do
    ...
    it "should expose a new state as @state" do
      State.should_receive(:new).and_return(mock_state)
      get :new
      assigns[:state].should equal(mock_state)
    end
  ...
  describe "responding to POST create" do
    ...
    describe "with valid params" do
      ...
      it "should expose a newly created state as @state" do
        State.should_receive(:new).with({'these' => 'params'}).and_return(mock_state(:save => true))
        post :create, :state => {:these => 'params'}
        assigns(:state).should equal(mock_state)
      end

      it "should redirect to the created state" do
        State.stub!(:new).and_return(mock_state(:save => true))
        post :create, :state => {}
    ...
    describe "with invalid params" do
      ...
      it "should expose a newly created but unsaved state as @state" do
        State.stub!(:new).with({'these' => 'params'}).and_return(mock_state(:save => false))
        post :create, :state => {:these => 'params'}
        assigns(:state).should equal(mock_state)
      end

      it "should re-render the 'new' template" do
        State.stub!(:new).and_return(mock_state(:save => false))
        post :create, :state => {}
  ...
  describe "responding to PUT udpate" do
    ...
    describe "with valid params" do
      ...
      it "should expose the requested state as @state" do
        State.stub!(:find).and_return(mock_state(:update_attributes => true))
        put :update, :id => "1"
        assigns(:state).should equal(mock_state)
      end
    ...
    describe "with invalid params" do
      ...
      it "should expose the state as @state" do
        State.stub!(:find).and_return(mock_state(:update_attributes => false))
        put :update, :id => "1"
        assigns(:state).should equal(mock_state)
      end
  ...
  describe "responding to DELETE destroy" do
    ...
    it "should redirect to the states list" do
      State.stub!(:find).and_return(mock_state(:destroy => true))
      delete :destroy, :id => "1"
